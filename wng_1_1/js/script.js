window.onload = function () {
    ...
    function processData(e) {
        ...
        xmlhttp.open("GET", "https://api.thecatapi.com/v1/images/search?size=full&mime_types=jpg&format=json&order=RANDOM&page=0&limit=10&category_ids&breed_ids", true);
